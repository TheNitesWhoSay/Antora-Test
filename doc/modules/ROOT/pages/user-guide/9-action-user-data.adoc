...
Strongly consider something akin to the following for labeling purposes as this will shunting string allocation, assembly, and storage costs onto every action:
