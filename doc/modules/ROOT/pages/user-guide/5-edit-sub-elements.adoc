...
When you have more complex source data, it remains easy to read and get const references to elements from further down.
...
It's also not difficult to write to _individual_ fields further down.
...
Now we can ``decrease_value`` method to perform some tracked mutations to item, and a method to get this editable item from an npc...
